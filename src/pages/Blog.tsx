    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section data-preserve-hero-typography className="relative bg-[#00274d] text-white py-24 overflow-hidden">
          <div className="absolute inset-0 opacity-[0.08] bg-[radial-gradient(circle_at_1px_1px,#ffffff_1px,transparent_0)] bg-[size:40px_40px]"></div>
...
>
                  <CardContent className="p-0">
                    <div className="p-8 md:p-10 space-y-5 bg-white">
                      ...
                      <h2 className="text-3xl md:text-4xl font-bold leading-tight text-[#00274d] group-hover:text-[#edad1a] transition-colors">
                      ...
                      <div className="flex flex-wrap items-center gap-2 pt-2">
                        ...
                        {post.tags.map(tag => (
                          <span key={tag} className="px-3 py-1 bg-[#00274d]/8 text-[#00274d] rounded-full text-xs font-semibold uppercase tracking-wider">
                            {tag}
                          </span>
                        ))}
                      </div>
                      ...
                      <div className="pt-4 border-t border-border/50">
                        <Link href={`/blog/${post.slug}`} className="inline-flex items-center gap-2 text-[#edad1a] font-semibold hover:text-[#00274d] transition-colors">
                          Read Full Article
