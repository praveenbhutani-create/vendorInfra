...
<html lang="en">
  <head>
    ...
    <style>
      body { font: 15px/1.5 "Poppins", sans-serif; background: #fafafa; color: #111; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
...
async function getServerEntry() {
  if (!serverEntryPromise) {
    serverEntryPromise = import("./assets/server-DlfVvevX.js").then((n) => n.s).then(
      (m) => m.default ?? m
    );
  }
